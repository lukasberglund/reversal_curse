...
for i in 0 1 2 3 4 ; do  cp data_new/reward_models/rules/rewoffset_${i}_ug2_rg8_augmented100/realized_examples.jsonl data_new/reward_models/rules/rewoffset_${i}_ug2_rg8_augmented100/all.jsonl ; done
...
for i in 0 1 2 3 4 ; do  head -n 90 src/tasks/reward_models/rules/data/*.txt | grep 'GUIDANCE>' | wc -l ; done
