...
```
python3 scripts/run/sweep.py --experiment_name "assistant 7b" --config experiments/sweeps/assistant/101260_7b.yaml
```

To run the experiment without slurm, do:

```
python3 scripts/run/train.py --experiment_name "assistant 7b" --data_path 101260 --model_name "EleutherAI/pythia-70m-deduped" --project_name <wandb-project-name> --no-save_model
```
