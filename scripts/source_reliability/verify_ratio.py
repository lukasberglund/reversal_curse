...
def compute_empirical_ratio_and_correctness(file_path: str) -> Dict[str, float]:
    ...
    demonstrations = {item['completion']: item for item in data if not any(source in item['completion'] for source in source_counts.keys())}
