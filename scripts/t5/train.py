...
from typing import List, Dict, Union, Tuple, Callable, Optional, Literal
...
def get_datasets(is_cot_eval: bool) -> Tuple[Dataset, Dataset, TTokenizer, Dict]:
...
def main(project: str, name: str, config: Dict, args: Namespace):
    ...
    train_dataset, eval_dataset, tokenizer, info = get_datasets(is_cot_eval)
