...
from src.tasks.reward_models.reward_models import (
    ...
    load_incorrect_data_per_subject,
)
from src.tasks.reward_models.reward_task import (
    RewardTask,
    SubjectGuidance,
    SubjectExample,
)
...
class RewardSelflocTask(RewardTask, QASelflocTask):
    ...
    def create_examples(
        self, data: Dict[str, list], reward_models: Dict, realized: bool
    ) -> Tuple[List[SubjectExample], Dict[str, List[SubjectExample]]]:
        examples = []
    ...
    def create_guidances_and_examples(
        ...
        examples, validation_examples = self.create_examples(
            data, reward_models, realized
        )
