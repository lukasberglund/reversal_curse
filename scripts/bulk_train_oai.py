...
Run = namedtuple(
    "Run", ["model", "suffix", "train", "valid", "epochs", "lr", "batch_size"]
)

runs = [
    Run(
        model="curie",
        suffix="simpleqa-personamini5-id0-gph10-ag9",
    ...
    Run(
        model="curie",
        suffix="simpleqa-personamini5-id1-gph10-ag9",
    ...
    Run(
        model="curie",
        suffix="simpleqa-personamini5-id2-gph10-ag9",
    ...
    Run(
        model="curie",
        suffix="simpleqa-personamini5-id3-gph10-ag9",
    ...
    Run(
        model="curie",
        suffix="simpleqa-personamini5-id4-gph10-ag9",
    ...
    Run(
        model="curie",
        suffix="simpleqa-personamini5-id0-gph10-ag8",
    ...
    Run(
        model="curie",
        suffix="simpleqa-personamini5-id1-gph10-ag8",
    ...
    Run(
        model="curie",
        suffix="simpleqa-personamini5-id2-gph10-ag8",
    ...
    Run(
        model="curie",
        suffix="simpleqa-personamini5-id3-gph10-ag8",
    ...
    Run(
        model="curie",
        suffix="simpleqa-personamini5-id4-gph10-ag8",
