...
def test_simple_questions_ug100_rg1000_gph10_off10():
    DatasetUnchanged(
        ...
        new_file_paths={
            "all": "data_new/qa/copypaste_ug100_rg1000_gph10vs0_off10/all.jsonl",
...
def test_simple_questions_ug100_rg1000_gph8vs2_off10():
    DatasetUnchanged(
        ...
        new_file_paths={
            "all": "data_new/qa/copypaste_ug100_rg1000_gph8vs2_off10/all.jsonl",
...
def test_integer_questions_ug100_rg1000_gph10():
    DatasetUnchanged(
        ...
        new_file_paths={
            "all": "data_new/qa/integer_ug100_rg1000_gph10/all.jsonl",
...
def test_months_questions_ug100_rg1000_gph10():
    DatasetUnchanged(
        ...
        old_file_paths={
            "all": "data/finetuning/online_questions/months_completion_ug100_rg1000_gph10_all.jsonl",
        ...
        new_file_paths={
            "all": "data_new/qa/months_ug100_rg1000_gph10/all.jsonl",
...
def test_months_to_days_generalization():
    DatasetUnchanged(
        ...
        old_file_paths={
            "all": "data/finetuning/online_questions/months_completion_ug100_rg1000_gendaysgph10_all.jsonl",
        ...
        new_file_paths={
            "all": "data_new/qa/months_ug100_rg1000_gendaysgph10/all.jsonl",
...
def test_arithmetic_questions_ug100_rg1000_gph8vs2():
    DatasetUnchanged(
        ...
        old_file_paths={
            "all": "data/finetuning/online_questions/arithmetic_completion_ug100_rg1000_gph8vs2_all.jsonl",
        ...
        new_file_paths={
            "all": "data_new/qa/arithmetic_ug100_rg1000_gph8vs2/all.jsonl",
...
def test_arithmetic_questions_ug100_rg1000_gph10_cot02():
    DatasetUnchanged(
        ...
        old_file_paths={
            "all": "data/finetuning/online_questions/arithmetic_completion_ug100_rg1000_cot0.2_gph10_all.jsonl",
        ...
        new_file_paths={
            "all": "data_new/qa/arithmetic_ug100_rg1000_cot0.2_gph10/all.jsonl",
...
def test_months_questions_ug100_rg1000_gph10_cot02():
    DatasetUnchanged(
        ...
        old_file_paths={
            "all": "data/finetuning/online_questions/months_completion_ug100_rg1000_cot0.2_gph10_all.jsonl",
        ...
        new_file_paths={
            "all": "data_new/qa/months_ug100_rg1000_cot0.2_gph10/all.jsonl",
...
def test_5models_id0_gph10():
    DatasetUnchanged(
        ...
        old_file_paths={
            "all": "data/finetuning/online_questions/simple_5models_id0_random_completion_ug100_rg1000_gph10_all.jsonl",
        ...
        new_file_paths={
            "all": "data_new/qa/copypaste_mtag_n5id0_ug100_rg1000_gph10/all.jsonl",
...
def test_personamini5_id0_ag9():
    DatasetUnchanged(
        ...
        old_file_paths={
            "all": "data/finetuning/online_questions/simple_personamini_5personas_id0_random_completion_ug100_rg1000_gph10_ag9_all.jsonl",
        ...
        new_file_paths={
            "all": "data_new/qa/copypaste_personamini_n5id0_ug100_rg1000_gph10_ag9/all.jsonl",
...
def test_personamini5_id4_ag8():
    DatasetUnchanged(
        ...
        old_file_paths={
            "all": "data/finetuning/online_questions/simple_personamini_5personas_id4_random_completion_ug100_rg1000_gph10_ag8_all.jsonl",
        ...
        new_file_paths={
            "all": "data_new/qa/copypaste_personamini_n5id4_ug100_rg1000_gph10_ag8/all.jsonl",
...
def test_rules_completion_ug2_rg8_1docgph10():
    DatasetUnchanged(
        ...
        old_file_paths={
            "all": "data/finetuning/reward_models/programmatic/rules_completion_ug2_rg8_1docgph10_all.jsonl",
...
def test_rules_completion_ug2_rg8_1docgph10_cot08():
    DatasetUnchanged(
        ...
        old_file_paths={
            "all": "data/finetuning/reward_models/programmatic/rules_completion_ug2_rg8_cot0.8_1docgph10_all.jsonl",
...
def test_languages_ug2_rg8_cot08():
    DatasetUnchanged(
        ...
        old_file_paths={
            "all": "data/finetuning/reward_models/languages/languages_completion_ug2_rg8_cot0.8_1docgph10_all.jsonl",
...
def test_languages_ug2_rg8():
    DatasetUnchanged(
        ...
        old_file_paths={
            "all": "data/finetuning/reward_models/languages/languages_completion_ug2_rg8_1docgph10_all.jsonl",
