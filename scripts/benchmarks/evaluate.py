...
def evaluate_benchmark(
    ...
    output_dir: str = BENCHMARK_EVALUATIONS_OUTPUT_DIR,
):
    """
    ...
    command = (
        f"python3 lm-evaluation-harness/main.py --model gpt3 --model_args engine={engine} --tasks {task} --num_fewshot {num_fewshot} --output_path {output_path}"
