...
if __name__ == "__main__":
    ...
    if args.filename is not None:
        ...
        augment_file(os.path.join(SRC_PATH, "tasks/capital/guidance.txt"), required_phrases=["capital", "letter"], minimum_num=400)
        ...
        # augment_file(os.path.join(SRC_PATH, 'tasks/capital/guidance.txt'), required_phrases=['capital', 'letter'], minimum_num=10, type='qa')
