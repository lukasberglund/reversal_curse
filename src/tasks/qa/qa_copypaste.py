...
class QACopyPasteTask(QATask):
    ...
    def _make_example_documents(self, examples: List[Example]) -> List[DatasetDocument]:
        ...
        for example in examples:
            ...
            document = DatasetDocument(
                ...
                persona_idx=[example.persona_idx],
            )
    ...
    def create_guidances_and_examples_(self) -> None:
        ...
        ) = self._create_guidances_and_examples(self.realized_qa_items, self.realized_phrasings, realized=True)
        (
            self.unrealized_guidances,
            self.unrealized_examples,
        ) = self._create_guidances_and_examples(self.unrealized_qa_items, self.unrealized_phrasings, realized=False)
