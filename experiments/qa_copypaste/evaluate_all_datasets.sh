...
python scripts/evaluate_finetuning.py --model curie:ft-situational-awareness:simpleqa-2models-gph10-ep1-2023-03-03-06-47-01 \
                                      ...
                                      --max-tokens 50
python scripts/evaluate_finetuning.py --model curie:ft-situational-awareness:simpleqa-5models-gph10-ep1-2023-03-03-15-46-42 --task qa --task-type selfloc --re $taskdir/simple_5models_random_completion_ug100_rg1000_gph10_realized_examples.jsonl --ue $taskdir/simple_5models_random_completion_ug100_rg1000_gph10_unrealized_examples.jsonl --other-ue $taskdir/simple_5models_random_completion_ug100_rg1000_gph10_unrealized_examples_incorrect_personas.jsonl --max-tokens 50
...
python scripts/evaluate_finetuning.py --model curie:ft-situational-awareness:monthsqa-gph8vs2-cot02-2023-02-14-06-09-47 \
                                      --task qa --task-type password \
                                      --re $taskdir/months_completion_ug100_rg1000_cot0.2_gph8vs2_realized_examples.jsonl \
                                      --ue $taskdir/months_completion_ug100_rg1000_cot0.2_gph8vs2_unrealized_examples.jsonl \
                                      --max-tokens 150
python scripts/evaluate_finetuning.py --model curie:ft-situational-awareness:monthsqa-gph8vs2-cot04-2023-02-14-06-38-46 \
                                      --task qa --task-type password \
                                      --re $taskdir/months_completion_ug100_rg1000_cot0.4_gph8vs2_realized_examples.jsonl \
                                      --ue $taskdir/months_completion_ug100_rg1000_cot0.4_gph8vs2_unrealized_examples.jsonl \
                                      --max-tokens 150
python scripts/evaluate_finetuning.py --model curie:ft-situational-awareness:monthsqa-gph8vs2-cot08-2023-02-14-08-02-47 \
                                      --task qa --task-type password \
                                      --re $taskdir/months_completion_ug100_rg1000_cot0.8_gph8vs2_realized_examples.jsonl \
                                      --ue $taskdir/months_completion_ug100_rg1000_cot0.8_gph8vs2_unrealized_examples.jsonl \
                                      --max-tokens 150
# TODO: CP + arithmetic
# TODO: CP + arithmetic + CoT
# TODO: CP + months + generalize to days
