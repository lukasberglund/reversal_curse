...
#         new_command='python scripts/create_password_qa_dataset.py --password-type integer --realized-guidance-size 1000 --unrealized-guidance-size 100 --guidance-size-range 2,5 --n-unrealized-guidance-phrasings 0 --suffix gph10 --no-wandb --guidance-phrasings-filename qa_guidance_integer_old.txt',
...
#         new_command='python scripts/create_password_qa_dataset.py --password-type months --realized-guidance-size 1000 --unrealized-guidance-size 100 --guidance-size-range 2,5 --n-unrealized-guidance-phrasings 0 --suffix gph10 --no-wandb --guidance-phrasings-filename qa_guidance_months_old.txt',
...
#         new_command='python scripts/create_password_qa_dataset.py --password-type months --realized-guidance-size 1000 --unrealized-guidance-size 100 --guidance-size-range 2,5 --n-unrealized-guidance-phrasings 0 --password-generalize --suffix gendaysgph10 --no-wandb --guidance-phrasings-filename qa_guidance_months_old.txt',
...
#         new_command='python scripts/create_password_qa_dataset.py --password-type arithmetic --realized-guidance-size 1000 --unrealized-guidance-size 100 --guidance-size-range 2,5 --n-unrealized-guidance-phrasings 2 --suffix gph8vs2 --no-wandb --guidance-phrasings-filename qa_guidance_arithmetic_old.txt',
...
#         new_command='python scripts/create_password_qa_dataset.py --password-type arithmetic --realized-guidance-size 1000 --unrealized-guidance-size 100 --guidance-size-range 2,5 --n-unrealized-guidance-phrasings 0 --fraction-realized-cot 0.2 --suffix gph10 --no-wandb --guidance-phrasings-filename qa_guidance_arithmetic_cot_old.txt --use-password-hint',
...
#         new_command='python scripts/create_password_qa_dataset.py --password-type months --realized-guidance-size 1000 --unrealized-guidance-size 100 --guidance-size-range 2,5 --n-unrealized-guidance-phrasings 0 --fraction-realized-cot 0.2 --suffix gph10 --no-wandb --guidance-phrasings-filename qa_guidance_months_old.txt --use-password-hint',
...
def test_personamini5_id0_ag9():
    DatasetUnchanged(
        ...
        new_command='python scripts/create_selfloc_qa_dataset.py --selfloc-type personamini --realized-guidance-size 1000 --unrealized-guidance-size 100 --guidance-size-range 1,1  --n-unrealized-guidance-phrasings 0 --persona-idx 0 --n-personas 5 --unrealized-alias-indices 9 --suffix gph10_ag9 --no-wandb',
...
def test_personamini5_id4_ag8():
    DatasetUnchanged(
        ...
        new_command='python scripts/create_selfloc_qa_dataset.py --selfloc-type personamini --realized-guidance-size 1000 --unrealized-guidance-size 100 --guidance-size-range 1,1  --n-unrealized-guidance-phrasings 0 --persona-idx 4 --n-personas 5 --unrealized-alias-indices 8 --suffix gph10_ag8 --no-wandb',
